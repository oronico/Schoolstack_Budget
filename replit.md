...
- **Lender Pro Forma export**: xlsx-populate (programmatic workbook generation)
- **PDF export**: PDFKit
...
- Lender Pro Forma export: `src/lib/lender-proforma-export.ts` — generates branded 5-year Pro Forma P&L workbook using xlsx-populate with enrollment, revenue, staffing, OpEx, NOI, DSCR, and cumulative cash sections. Uses SchoolStack brand colors (Navy/Amber/Teal).
...
- **Export step**: Four download options — Excel workbook (cross-tab formulas), Lender Pro Forma (branded P&L workbook with DSCR), Pro Forma PDF (financial projections summary), and Loan Readiness PDF (CFO analysis with lender readiness assessment)
