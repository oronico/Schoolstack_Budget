...
// Task #541 — third demo model exercising the charter / public-funding
// path. Adapted from the CHARTER_SCHOOL legislator sample, with extra
// `openingYear` / `currentStudents` fields to match the shape the wizard
// uses when reviewers open the model.
const CHARTER_SCHOOL_MODEL = {
  name: "Liberty STEM Charter School (Demo Charter School)",
  schoolStage: "new_school" as const,
