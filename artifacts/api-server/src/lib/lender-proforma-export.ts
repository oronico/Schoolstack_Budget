...
function buildAssumptions(wb: ExcelJS.Workbook, input: Record<string, string | number>) {
  ...
  ws.getCell("E2").value = "Calculated \u2014 driven by formula";
  ws.getCell("E2").font = { name: "Calibri", size: 10, italic: true, color: { argb: "FF666666" } };
...
function buildSummary(wb: ExcelJS.Workbook, input: Record<string, string | number>, res: LenderResults) {
  ...
  ws.getCell("B21").value = "Generated by SchoolStack Budget (budget.schoolstack.ai)";
  ws.getCell("B21").font = { name: "Calibri", size: 11, italic: true, color: { argb: "FF6B7280" } };
