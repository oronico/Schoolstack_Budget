...
export const charterPublicFunding = {
  ...
  staffingRows: [
    ...
    { id: "s4", roleName: "Core Teachers", functionCategory: "instructional", employmentType: "full_time", fte: 6, annualizedRate: 52000, benefitsEligible: true, benefitsRate: 28, payrollTaxRate: 7.65, payrollLike: false },
