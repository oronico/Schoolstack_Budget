...
export function ConsultantStep({ jumpToStep, modelId, revenueStepNumber, assumptionsStepNumber }: ConsultantStepProps) {
  ...
  return (
    <>
      ...
      <ConsultantAnalysisView
        ...
        assumptionsStepNumber={assumptionsStepNumber}
