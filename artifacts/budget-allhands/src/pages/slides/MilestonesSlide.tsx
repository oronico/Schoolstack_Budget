    ...
    <div className="w-screen h-screen overflow-hidden relative" style={{ background: "linear-gradient(180deg, #FAF9F7 0%, #F0EDE8 100%)" }}>
      ...
      <div className="flex flex-col h-full px-[6vw] pt-[6vh]">
        ...
        <div className="flex items-end gap-[3vw] mb-[4vh]">
          ...
          <span className="font-display text-primary/30" style={{ fontSize: "6vw", lineHeight: 0.85 }}>149</span>
        ...
        <div className="flex gap-[2vw] flex-1">
          <div className="flex-1 flex flex-col gap-[1.5vh]">
            ...
            <div className="bg-white rounded-[0.8vw] p-[1.5vw] border border-text/5">
              <div className="flex items-center gap-[0.5vw] mb-[0.5vh]">
                <div className="w-[0.5vw] h-[0.5vw] rounded-full bg-primary" />
                <span className="font-body font-bold text-text" style={{ fontSize: "1.4vw" }}>Lender-Readiness Scoring</span>
              </div>
              <p className="font-body text-muted" style={{ fontSize: "1.3vw" }}>Real underwriting criteria evaluation with pass/warn/fail signals</p>
            </div>
            <div className="bg-white rounded-[0.8vw] p-[1.5vw] border border-text/5">
              <div className="flex items-center gap-[0.5vw] mb-[0.5vh]">
                <div className="w-[0.5vw] h-[0.5vw] rounded-full bg-primary" />
            ...
            <div className="bg-white rounded-[0.8vw] p-[1.5vw] border border-text/5">
              ...
              <p className="font-body text-muted" style={{ fontSize: "1.3vw" }}>Plain-English explanations of every metric and ratio</p>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col gap-[1.5vh]">
            <div className="bg-white rounded-[0.8vw] p-[1.5vw] border border-text/5">
              ...
              <p className="font-body text-muted" style={{ fontSize: "1.3vw" }}>Comprehensive Excel export with formulas, not just static numbers</p>
            </div>
            <div className="bg-white rounded-[0.8vw] p-[1.5vw] border border-text/5">
              <div className="flex items-center gap-[0.5vw] mb-[0.5vh]">
                <div className="w-[0.5vw] h-[0.5vw] rounded-full bg-accent" />
                <span className="font-body font-bold text-text" style={{ fontSize: "1.4vw" }}>Coaching Co-Pilot</span>
              </div>
              <p className="font-body text-muted" style={{ fontSize: "1.3vw" }}>Context-specific guidance at every step of the wizard</p>
            </div>
            <div className="bg-white rounded-[0.8vw] p-[1.5vw] border border-text/5">
              <div className="flex items-center gap-[0.5vw] mb-[0.5vh]">
                <div className="w-[0.5vw] h-[0.5vw] rounded-full bg-accent" />
                <span className="font-body font-bold text-text" style={{ fontSize: "1.4vw" }}>Formula-Driven Excel</span>
              </div>
              <p className="font-body text-muted" style={{ fontSize: "1.3vw" }}>Live formulas so lenders can adjust assumptions themselves</p>
            </div>
